...
default_fields = ['[no. of victims, no. of perpetrators, origin of perpetrator, origin of victim, incident description]']
# options for Text Comparison.
if task == 'EXTRACT_FIELDS':
    ...
    fields = st.selectbox("Fields to Extract",
...
if st.button("Run Script"):
    ...
    if task == 'TEXT_COMPARATOR':
        ...
        file_handler.write_config(arguments_config, config_file_name='arguments_passer.yaml')
    if task == "EXTRACT_FIELDS" and fields != default_fields:
        arguments_config['EXTRACT_FIELDS']['fields'] = fields
        file_handler.write_config(arguments_config, config_file_name='argument_passer.yaml')
