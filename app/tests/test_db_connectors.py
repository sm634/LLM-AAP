import random
import time
from connectors.vector_db_connector import MilvusConnector, SingleStoreConnector
...
def test_single_store():
    """
    A simple test function to see if single store can be connected to.
    """
    sscon = SingleStoreConnector()

def test_elasticsearch():
    """
    A simple test function to see if elasticsearch can be connected to.
    """
